...
To unlock subscriber-only features (lens search, Quick Answer, Assistant, ask-page, translate, and subscriber Summarizer), you need a Kagi Session Token.
...
![Translate command demo](/images/demos/translate.gif)
