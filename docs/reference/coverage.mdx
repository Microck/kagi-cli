...
|------|---------|----------|
| Session Token | ✅ | search, summarize --subscriber, assistant, translate |
...
**Translate runtime note:** `kagi translate` additionally requires `python3` with the `curl_cffi` package installed.
