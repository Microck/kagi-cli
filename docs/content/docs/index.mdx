...
- **Version Control Friendly**: Configuration lives in a simple TOML file. Keep credentials out of it: commit a redacted template and supply tokens via `kagi auth` or environment variables.
